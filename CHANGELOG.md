...
### Fixed
- **Invoice Finalization Date**: Resolved an issue where draft invoices retained their original creation date after being finalized. Dates now default to 'today' upon finalization to ensure chronological document numbering.
