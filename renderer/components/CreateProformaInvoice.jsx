    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">
          {editId ? (isFinalized ? `Edit Proforma Invoice ${docNumber}` : 'Edit Draft Proforma Invoice') : 'Create New Proforma Invoice'}
        </h1>
        {!editId && nextInvoiceNumber && (
          <div className="text-sm text-gray-500">
            Next proforma invoice number: <span className="font-medium text-gray-900">{nextInvoiceNumber}</span>
          </div>
        )}
        {editId && isFinalized && docNumber && (
          <div className="text-sm text-gray-500">
            Proforma invoice number: <span className="font-medium text-gray-900">{docNumber}</span>
          </div>
        )}
      </div>
      ...
      <div className="space-y-6">
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-sm text-gray-500">
              Proforma invoice - not a fiscal document
            </div>
          </div>
